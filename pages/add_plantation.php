            ...
            <div class="col-lg-5 mb-4">
                <div class="card-wrapper mb-4">
                    <div class="light-card bg-light" style="width:32rem;">
                        <div class="card-header text-center" style="height: 100px; font-size: 40px;">Add new plantation profile</div>
                        <div class="card-body">
                            <form action="../includes/add_plantation_script.php" method="post" enctype="multipart/form-data">
